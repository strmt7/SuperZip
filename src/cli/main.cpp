...
void usage() {
    std::cout
        ...
        << "  superzip_cli compress --format zip|tar|tar.gz|tgz|gz|gzip|z|compress|cpio|ar --output <archive> [--sha256] [--defender-scan] <path>...\n"
        ...
        << "  superzip_cli extract --format auto|zip|tar|tar.gz|tgz|gz|gzip|z|compress|cpio|ar|deb --output <directory> [--overwrite] [--sha256] [--defender-scan] <archive>\n"
