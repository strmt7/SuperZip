...
// is a miniz 1-9 level, and `progress_callback` receives synchronous progress snapshots. Outputs: Returns operation
// statistics; throws `ArchiveError`/`SecurityError` on source, path, or ZIP writer failures.
