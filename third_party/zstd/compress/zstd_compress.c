...
static size_t ZSTD_buildSeqStore(ZSTD_CCtx* zc, const void* src, size_t srcSize)
{
    ...
    /* See upstream note 3090. MIN_CBLOCK_SIZE changed from 3 to 2, so this
     * branch keeps the additional byte for consistent block-size handling. */
                               ...
                               ZSTD_ParamSwitch_e externalRepSearch)
{
    ...
    /* Fast parsing mode is not used in noBlockDelim mode in this release. */
                          ...
                          const void* src, size_t srcSize)
{
    ...
    while (remaining) {
        ...
        /* If blocks are too small, emit as a nocompress block. See upstream
         * note 3090 for the MIN_CBLOCK_SIZE adjustment. */
