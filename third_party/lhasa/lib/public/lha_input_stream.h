...
typedef struct {
	 ...
	 *
	 * @param handle       Opaque caller-owned stream handle.
 ...
 * @param handle       Opaque caller-owned stream handle to pass to callback
 *                     functions. The caller must keep it alive until this
 *                     input stream is freed.
