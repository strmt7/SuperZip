...
#ifndef LHASA_LH_NEW_DECODER_TEMPLATE_H
#define LHASA_LH_NEW_DECODER_TEMPLATE_H

// Decoder for "new-style" LHA algorithms, used with LHA v2 and onwards
// (-lh4-, -lh5-, -lh6-, -lh7-).
//
// This file is designed to be a template included by other
...
#include "bit_stream_reader_template.h"

// Include tree decoder.

typedef uint16_t TreeElement;
#include "tree_decode_template.h"
...
{
	lhasa_bytes_set(decoder->ringbuf, ' ', RING_BUFFER_SIZE);
...
#endif /* LHASA_LH_NEW_DECODER_TEMPLATE_H */
